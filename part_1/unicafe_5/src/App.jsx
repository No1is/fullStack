...
const StatisticLine = (props) => {
  if (props.text === 'all'){
    return <All total={props.total} />
  }
  if (props.text === 'average'){
    return <Avg good={props.good} bad={props.bad} total={props.total} />
  }
...
const Statistics = ({ good,bad,neutral,total }) => {
  ...
  return(
    <div>
      ...
      <StatisticLine text='all' total={totalValue} />
      <StatisticLine text='average' good={good} bad={bad} total={totalValue} />
      <StatisticLine text='positive' good={good} total={totalValue} />
    </div>
  )
}
const App = () => {
