import { NonSensitivePatient, Patient, NewPatient, Gender, Entry, EntryWithoutId } from '../types/types';
...
export default { getNonSsnPatients, addNewPatient, getPatientDetails, addNewEntry }