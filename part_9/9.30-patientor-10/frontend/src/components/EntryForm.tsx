...
import { EntryWithoutId, Entry, Diagnosis, SickLeave, Discharge, HealthCheckRating, EntryType } from '../types';
...
const EntryForm = ({ id, toggle, addEntryList, diagnosisList }: FormProps) => {
