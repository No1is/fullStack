...
import { Typography, createTheme, ThemeProvider, List, ListItem, ListItemText, Divider } from '@mui/material';
            ...
            <div style={{ paddingTop: 20 }}>
                ...
                <List>
                    {patient.entries.map(e => (
                        <div>
                            <ListItem key={e.id} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                                <ListItemText 
